...
exec("~/data/shapes/br_hero/player.cs");
...
{
   filename    = "~/data/sound/wetstep.wav";
   description = AudioClose3d;
   preload = true;
};
...
datablock AudioProfile(WaterBreathSound)
{
...
datablock AudioProfile(ExitingWaterSound)
{
   filename    = "~/data/sound/exit_water.wav";
   description = AudioClose3d;
   preload = true;
};

datablock AudioProfile(EnteringWaterSound)
{
...
datablock AudioProfile(EnteringWaterLightSound)
{
   filename    = "~/data/sound/splashl.wav";
   description = AudioClosest3d;
   preload = true;
};
...
datablock PlayerData(PlayerBody)
{
   ...
   className = Armor;
   shapeFile = "~/data/shapes/br_hero/br_hero_anim.dts";
   cameraMaxDist = 3;
   computeCRC = true;
   ...
   waterBreathSound     = WaterBreathSound;
   ...
   impactWaterEasy      = EnteringWaterLightSound;
   impactWaterMedium    = EnteringWaterSound;
   impactWaterHard      = EnteringWaterSound;
