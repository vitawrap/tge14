...
#ifdef UNICODE
   static UTF8 buf[512];
   convertUTF16toUTF8((const UTF16*)mDeviceInstance.tszInstanceName, buf, sizeof(buf));
...
#ifdef UNICODE
   static UTF8 buf[512];
   convertUTF16toUTF8((const UTF16*)mDeviceInstance.tszProductName, buf, sizeof(buf));
   return (const char *)buf;
#else
