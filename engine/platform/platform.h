...
#include <stdarg.h>  // Necessary for cross-platform va_list
...
{  // x86 properties
   ...
   CPU_PROP_SSE3      = (1<<7),     // PentiumD/Athlon64 SIMD
   CPU_PROP_SSE4_1    = (1<<8),     // IntelCore/K10 SIMD
   CPU_PROP_SSE4_2    = (1<<9),     // IntelCore/K10 SIMD
};
...
void dQsort(void *base, dsize_t nelem, dsize_t width, S32 (QSORT_CALLBACK *fcmp)(const void *, const void *));
