...
fluid::fluid( void )
{
    ...
    m_pTerrain        = NULL;
    m_TerrainSquareSize = 8;
    m_TerrainSquareSizeLog2 = 3;
...
void fluid::SetTerrainData( u16* pTerrainData, S32 squareSize )
{
    m_pTerrain = pTerrainData;
    m_TerrainSquareSize = squareSize;
    m_TerrainSquareSizeLog2 = mLog2(squareSize);
    RebuildMasks();
}
