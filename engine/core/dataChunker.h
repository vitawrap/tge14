...
//----------------------------------------------------------------------------
/// Implements a chunked stack allocator.
///
/// This works in a way similar to GNU obstacks.
/// Alloc will advance the free space and free
/// will free all blocks up to the free point.
class StackAllocator
{
public:
    typedef S32 StackMarker;
...
public:
    void* alloc(S32 size, StackMarker&);
    void free(void* ptr, StackMarker&);
    void freeBlocks();

    StackAllocator(S32 size=DataChunker::ChunkSize);
    ~StackAllocator();
};
