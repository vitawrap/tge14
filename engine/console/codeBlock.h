...
public:
   ...
   void findBreakLine(U64 ip, U32 &line, U64 &instruction);
   void getFunctionArgs(char buffer[1024], U64 offset);
   ...
   ConsoleValue compileExec(StringTableEntry fileName, const char *script, 
      bool noCalls, int setFrame = -1, bool noretval = false);
   ...
   ConsoleValue exec(U64 offset, const char *fnName, Namespace *ns, U32 argc,
