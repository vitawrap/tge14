...
struct PlayerData: public ShapeBaseData {
   ...
   F32 maxForwardCrouchSpeed;      ///< Maximum crouching forward speed when running
   F32 maxBackwardCrouchSpeed;     ///< Maximum crouching backward speed when running
   F32 maxSideCrouchSpeed;         ///< Maximum crouching side speed when running
   ...
   bool canSwim;                   ///< Swim flag for datablock
   F32 swimForce;                  ///< Swimming force
   ...
   Point3F boxCrouchSize;     ///< Width, depth, height
...
protected:
   ...
   enum MaskBits : U64 {
      ActionMask   = (U64)Parent::NextFreeMask << 0,
      MoveMask     = (U64)Parent::NextFreeMask << 1,
      ImpactMask   = (U64)Parent::NextFreeMask << 2,
   ...
   bool mCrouching;                 ///< Crouching?
   bool mSwimming;                  ///< Swimming?
   bool mHeadUp;                    ///< Head is up?
   bool mJetting;                   ///< Jetting around?
  ...
  protected:
   ...
   void createSplash( Point3F &pos );               ///< Creates a splash
