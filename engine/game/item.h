...
class Item: public ShapeBase
{
  ...
  public:
   ...
   enum MaskBits : U64 {
      HiddenMask   = (U64)Parent::NextFreeMask,
      ThrowSrcMask = (U64)Parent::NextFreeMask << 1,
      PositionMask = (U64)Parent::NextFreeMask << 2,
      RotationMask = (U64)Parent::NextFreeMask << 3,
      NextFreeMask = (U64)Parent::NextFreeMask << 4
   };
