...
IMPLEMENT_CONSOLETYPE(ShockwaveData)
...
bool ShockwaveData::preload(bool server, char errorBuffer[ErrorBufferSize])
{
...
void Shockwave::initPersistFields()
{
   ...
   addField("initialPosition",    TypePoint3F,   Offset(mInitialPosition,  Shockwave));
   addField("initialNormal",      TypePoint3F,   Offset(mInitialNormal,    Shockwave));
