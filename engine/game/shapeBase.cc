...
void ShapeBase::processTick(const Move* move)
{
   ...
   if (isServerObject()) {
      ...
      // update wet state
      bool wet = mWaterCoverage > 0.4f;
      for (S32 i = 0; i < MaxMountedImages; ++i)
        setImageWetState(i, wet); // more than 40 percent covered
...
F32 ShapeBase::getUpdatePriority(CameraScopeQuery *camInfo, U64 updateMask, S32 updateSkips)
{
